...
- Capa de aplicación 
    ...
    - [ ] Se definen _use cases_ a partir de los _services de `domain` mediante patrón **command**.
...
- Capa de infrastructure
    ...
    - [ ] Los handlers invocan a los _use cases_ (como antes hacían con los _services_).
...
- De capas apiladas a concentricas
