...
public abstract class BaseHandler {
  ...
  protected void handleBusinessException(HttpExchange exchange, Exception e) throws IOException {
    if (e instanceof com.astrobookings.core.domain.models.ValidationException) {
      handleError(exchange, 400, e.getMessage());
    } else if (e instanceof com.astrobookings.core.domain.models.NotFoundException) {
      handleError(exchange, 404, e.getMessage());
    } else if (e instanceof com.astrobookings.core.domain.models.PaymentException) {
