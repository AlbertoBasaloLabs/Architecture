...
import com.astrobookings.core.domain.models.FlightStatus;
...
class InMemoryFlightRepository implements FlightRepository {
  ...
  static {
    ...
    Flight f1 = new Flight(dummyFlight1Id, dummyRocketId, LocalDateTime.now().plusDays(40), 5000.0, 5,
        FlightStatus.SCHEDULED);
    var dummyFlight2Id = "10000000-0000-0000-0000-000000000002";
    Flight f2 = new Flight(dummyFlight2Id, dummyRocketId, LocalDateTime.now().plusDays(10), 6000.0, 5,
        FlightStatus.SCHEDULED);
    var dummyFlight3Id = "10000000-0000-0000-0000-000000000003";
    Flight f3 = new Flight(dummyFlight3Id, dummyRocketId, LocalDateTime.now().plusDays(10), 6000.0, 5,
